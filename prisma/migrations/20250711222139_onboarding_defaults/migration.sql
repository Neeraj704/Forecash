/*
  ...
  - You are about to drop the column `linkAccounts` on the `OnboardingPreference` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "OnboardingPreference" DROP COLUMN "linkAccounts";
